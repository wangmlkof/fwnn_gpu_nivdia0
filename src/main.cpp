...
{
		accelerator_cl gpu_acc;
		//first read the mnist data
		cout<<"open mnist database"<<endl;
		mnist_db train_db("/home/ivip/wml/mnist_db/train-images.idx3-ubyte",
				"/home/ivip/wml/mnist_db/train-labels.idx1-ubyte");
		mnist_db test_db("/home/ivip/wml/mnist_db/t10k-images.idx3-ubyte",
				"/home/ivip/wml/mnist_db/t10k-labels.idx1-ubyte");

		neural_network nn(784,10);
		cout<<"add accelerator to neural network"<<endl;
		nn.add_accelerator(gpu_acc);
